...
<div class='col' id="tela">
    ...
    <h1 class="header" style='padding:10px;'>Figuras <small class="text-muted">Gerenciamento de Figura</small></h1>
    <hr>
    
    <div class='row'>
        <div class='col'>
            <div class='card p-4'>
                <form id="frm-template" action="<?=base_url('index.php/figuras/update/'.$figura->id)?>" method='post' enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="col-sm">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome" type="text" class="form-control" value="<?=$figura->nome?>" placeholder="Ex.: Abacaxi Hawai" required>
                            </div>
                        </div>
                        <div class="col-sm col-12">
                            <div class="input-group mb-3">
                                ...
                                <label class='form-control' for='src' id="label-img" style="cursor:pointer;"><?=$figura->src?></label>
