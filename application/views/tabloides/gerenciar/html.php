                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout5" value='5' class="form-check-input" <?php echo ($template->layout == 5 ? "checked" : ""); ?>>
                                    <label for="layout5" class="form-check-label">Layout Horizontal</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout6" value='6' class="form-check-input" <?php echo ($template->layout == 6 ? "checked" : ""); ?>>
                                    <label for="layout6" class="form-check-label">Faixas para Gôndolas</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout7" value='7' class="form-check-input" <?php echo ($template->layout == 7 ? "checked" : ""); ?>>
                                    <label for="layout7" class="form-check-label">Banner Bolsão A2 Vertical</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout8" value='8' class="form-check-input" <?php echo ($template->layout == 8 ? "checked" : ""); ?>>
                                    <label for="layout8" class="form-check-label">Atacado</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout9" value='9' class="form-check-input" <?php echo ($template->layout == 9 ? "checked" : ""); ?>>
                                    <label for="layout9" class="form-check-label">Varejo</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout10" value='10' class="form-check-input" <?php echo ($template->layout == 10 ? "checked" : ""); ?>>
                                    <label for="layout10" class="form-check-label">Atacado e Varejo - Horizontal</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout11" value='11' class="form-check-input" <?php echo ($template->layout == 11 ? "checked" : ""); ?>>
                                    <label for="layout11" class="form-check-label">Varejo - Horizontal</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout12" value='12' class="form-check-input" <?php echo ($template->layout == 12 ? "checked" : ""); ?>>
                                    <label for="layout12" class="form-check-label">2 Preços - Sem Imagem 2</label>
                                </div>
                                <!-- O 13 NÃO PRECISA, POIS PEGA OS TEMPLATES DO 1 -->
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout14" value='14' class="form-check-input" <?php echo ($template->layout == 14 ? "checked" : ""); ?>>
                                    <label for="layout14" class="form-check-label">Bolsão A3x4 - Horizontal</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout15" value='15' class="form-check-input" <?php echo ($template->layout == 15 ? "checked" : ""); ?>>
                                    <label for="layout15" class="form-check-label">2 Preços - Sem Imagem</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout16" value='16' class="form-check-input" <?php echo ($template->layout == 16 ? "checked" : ""); ?>>
                                    <label for="layout16" class="form-check-label">2 preços Horizontal sem imagem 8x20</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout17" value='17' class="form-check-input" <?php echo ($template->layout == 17 ? "checked" : ""); ?>>
                                    <label for="layout17" class="form-check-label">1 preço Horizontal sem imagem 8x20</label>
                                </div>
                                <div class="form-check form-check-inline col-sm-5">
                                    <input type="radio" name="layout" id="layout18" value='18' class="form-check-input" <?php echo ($template->layout == 18 ? "checked" : ""); ?>>
