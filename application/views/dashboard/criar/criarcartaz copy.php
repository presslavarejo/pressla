<script>
    function criaCartaz() {
        ...
        if ($('#src_template').val() != null) {
            ...
            var canvasHTML = "<canvas id='cartaz" + ($("#layout").val() != 6 && $("#layout").val() != 16 && $("#layout").val() != 17 ? $("input[name='quadrante']:checked").val() : $("input[name='faixa']:checked").val()) + "' width='" + w + "' height='" + h + "'></canvas>"

            if ($('#container_cartaz' + ($("#layout").val() != 6 && $("#layout").val() != 16 && $("#layout").val() != 17 ? $("input[name='quadrante']:checked").val() : $("input[name='faixa']:checked").val())).html() != undefined) {

                $('#container_cartaz' + ($("#layout").val() != 6 && $("#layout").val() != 16 && $("#layout").val() != 17 ? $("input[name='quadrante']:checked").val() : $("input[name='faixa']:checked").val())).html(canvasHTML);
            ...
            var ctx = carregarContextoCanvas('cartaz' + ($("#layout").val() != 6 && $("#layout").val() != 16 && $("#layout").val() != 17 ? $("input[name='quadrante']:checked").val() : $("input[name='faixa']:checked").val()));
            var cartaz = carregarContextoCanvas($("#layout").val() != 7 ? 'cartaz' : 'cartaz_a2');
            if (ctx && cartaz) {
                //Crio uma imagem com um objeto Image de Javascript
                var fundo = new Image();
                //indico a URL da imagem
                if ($("#layout").val() == 6 || $("#layout").val() == 16) {
                ...
                fundo.onload = function() {
                    ...
                    if ($("#layout").val() == 1 || $("#layout").val() == 13) {
                        ...
                        if ($("#layout").val() == 3 || $("#layout").val() == 4) {
                            ...
                            liberaCampos(true);
                            $(".cordesc").show();
                        } else if ($("#layout").val() == 7 || $("#layout").val() == 14) {
                            $("#tamanho_comum").hide();
                            $("#tamanho_maior").show();
                        ...
                        // TABLOIDES
                        if ($("#layout").val() == 18 || $("#layout").val() == 19 || $("#layout").val() == 20 || $("#layout").val() == 23) {
                            $("#container_codigo").hide();
                            $("#container_preco_anterior").hide();
                            $("#container_unidade").hide();
