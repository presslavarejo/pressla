<div class='col offset-md-2'>
    ...
    <h1 class="header" style='padding:10px;'><a  href="<?=base_url('index.php/templates/tipos');?>">Categorias </a> <small class="text-muted">Gerenciamento de Categoria</small></h1>
    <hr>
    
    <div class='row'>
        <div class='col'>
            <div class='card p-4'>
                <form id="frm-template" action="<?=base_url('index.php/templates/updatetipo/'.$template_tipo->id)?>" method='post' enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="col-sm">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome" type="text" class="form-control" value="<?=$template_tipo->tipo?>" placeholder="Ex.: Oferta" required>
                            </div>
                        </div>
                    </div>
